...
public class AIChatConstants {
    ...
    public static final String QWEN_MODEL = "qwen-max-longcontext";
    ...
    public static final String NOTEBOOK_FILE = "./ai_notebook.txt";
    public static final String PARAMS_FILE = "./api_params.ser";
    public static final String PROMPTS_FILE = "./ai_prompts.ser";


    public static final String HOW_TO_USE_NOTEBOOK = """
                使用以下格式将你认为的重要信息存储到笔记本中：
